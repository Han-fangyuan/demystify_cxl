...
| T | Type of operation | 0 | 0 - 3 | <ul><li>0 = single-op latency</li><li>1 = bandwidth</li><li>2 = pointer chasing</li><li>3 = block-access latency</li></ul> |
...
| o | Operation | 0 (Load) | 0 - 4 | <ul><li>0 = Load</li><li>1 = NT-load</li><li>2 = Store</li><li>3 = Nt-store</li><li>4 = movdir64B (only in bandwidth tests)</li></ul> |
